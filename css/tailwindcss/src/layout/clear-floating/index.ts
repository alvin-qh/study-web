...
-->
<img class="float-left w-28 h-28" src="${image}">
...
-->
<img class="float-left w-28 h-28" src="${image}">
<img class="float-right w-28 h-28" src="${image}">
<p class="clear-right">
  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
  Nam venenatis et lorem sit amet vehicula. Etiam vel
  nibh nec nisi euismod mollis ultrices condimentum velit.
...
-->
<img class="float-left w-28 h-28 m-2" src="${image}">
<img class="float-right w-28 h-28 m-2" src="${image}">
<p class="clear-none">
  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
  Nam venenatis et lorem sit amet vehicula. Etiam vel
  nibh nec nisi euismod mollis ultrices condimentum velit.
