...
module.exports = {
  ...
  configureWebpack: (config) => {
    config.resolve.alias = { common: './src/common.ts', ...config.resolve.alias };
    config.entry = { vendor: ['vue', /* 'view-design', */'common'], ...config.entry };
  },
  ...
  devServer: {
    ...
    // https: {
    //   https: true,
    //   key: fs.readFileSync('ca/127.0.0.1+3-key.pem'),
