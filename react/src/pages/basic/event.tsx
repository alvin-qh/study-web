import { Button, ButtonSharedProps, Intent, OverlayToaster, Position } from "@blueprintjs/core";
 ...
 * 通过函数定义事件处理
 */
const ActionButton = ({ children, className, ...props }: ButtonSharedProps): React.JSX.Element => {
 ...
 */
const ActionButtonWithArgs1 = ({ children, className, ...props }: ButtonSharedProps) => {
 ...
 */
const ActionButtonWithArgs2 = ({ children, className, ...props }: ButtonSharedProps) => {
  const handleClick = (action: string): void => {
