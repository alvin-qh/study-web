import { Button, Icon, InputGroup, Intent, Popover, Tooltip } from "@blueprintjs/core";
 ...
 */
const NumberList = ({ count, ...props }: NumberListProp): React.JSX.Element => {
  return (<ul {...props}>
    {
...
const WordList = (props: { className: string }): React.JSX.Element => {
   ...
   */
  const createListItem = (): React.JSX.Element[] => {
    const wordList: React.JSX.Element[] = [];
...
const BasicLoop = (): React.JSX.Element => {
  return (
    <>
