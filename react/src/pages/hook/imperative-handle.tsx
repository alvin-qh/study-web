 ...
 *      const Comp = (props, ref): JSX.Element => {...};
...
import { type ForwardedRef, forwardRef, type JSX, useCallback, useImperativeHandle, useRef } from 'react';
...
const HookImperativeHandle = (): JSX.Element => {
  ...
  return (
    <div className="w-1/3 px-4 py-6">
      ...
      <button
        type="button"
        className="mt-4 ml-12 border px-4 py-2 rounded-md
         bg-sky-400 text-white font-medium shadow-md
         focus:outline-none active:bg-sky-500 active:shadow-none"
