...
<template>
  <div class="slot">
    ...
    <div>
      ...
      <simple-slot>
        <p>Hello Slot1</p>
        <simple-slot>Hello Slot2</simple-slot>
      </simple-slot>
    </div>
    ...
    <div class="slot-no-render">
      ...
      <no-render-component v-slot="{ pointX, pointY }">
        <div class="row">
          <div>X</div>
          <div>{{ pointX }}</div>
        </div>
