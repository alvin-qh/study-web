 ...
 * 定义显示色彩的 Box 组件
 */
const ColorBox = ({ backgroundColor }: { backgroundColor: string }): React.JSX.Element => {
  return (
 ...
 * Theme 设置组件
 */
const ContextSetting = ({ onThemesChanged }: ContextSettingProp): React.JSX.Element => {
  // 获取 Context 中设置的值
 ...
 */
const ContextButton = (): React.JSX.Element => {
  // 获取 Context 中设置的值
  const theme = useContext(ThemeContext);
 ...
 */
const ContextText = ({ children }: ContextTextProps): React.JSX.Element => {
  // 获取 Context 中设置的值
  const theme = useContext(ThemeContext);
...
const HookContext = (): React.JSX.Element => {
