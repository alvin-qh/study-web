...
const CountState = (): React.JSX.Element => {
  ...
  return (
    <>
      ...
      <div className="space-y-4 flex flex-col justify-center mt-4">
        <p className="text-center text-lg font-bold">You clicked <b className="text-blue-600 text-2xl">{count}</b> times</p>
        <Button
...
const CountEffect = (): React.JSX.Element => {
  const [count, setCount] = useState<number>(0);
...
const HookPreview = (): React.JSX.Element => (
  <div className="w-1/3">
